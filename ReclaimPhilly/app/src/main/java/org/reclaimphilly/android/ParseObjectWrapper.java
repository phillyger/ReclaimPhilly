...
//        po.put(f_createdBy, User.getAnnonymousUser());
	}
    ...
    public static final Creator<ParseObjectWrapper> CREATOR
	    = new Creator<ParseObjectWrapper>() {
    ...
    public ParseObjectEssentials getEssentials()
    {
        ...
        if (cat == null && cby == null)
            return ParseObjectEssentials.getDefault();
